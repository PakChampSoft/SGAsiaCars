...
@section('content')
  ...
  <section id="main-section">
    <div class="custom-container-contact-us">
      <h1 class="text-2xl font-bold text-dark-black pt-3 text-center text-success">Thank You For Contact Us! Your Message Submitted Successfully.</h1>
      <div class="row">
      ...
      <p class="text-dark-black p-3">You will recieve an email shortly</b>.
