...
@section('content')
  ...
  <section id="main-section">
    <div class="custom-container">
        <h1 class="text-2xl font-bold text-center text-dark-black pt-2">We Are (Company)</h1>
        ...
        <div class="grid grid-cols-1 mt-4 gap-y-4">
          ...
          <div class="mb-2 mt-2">
              <h2 class="text-xl font-bold text-dark-black">1. Communication</h2>
          ...
          <div class="mb-2 mt-2">
              <h2 class="text-xl font-bold text-dark-black">2. Accuracy</h2>
          ...
          <div class="mb-2 mt-2">
              <h2 class="text-xl font-bold text-dark-black">3. Performance</h2>
          ...
          <div class="mb-2 mt-2">
              <h2 class="text-xl font-bold text-dark-black">4. Honesty and Integrity</h2>
          ...
          <div class="text-dark-black pb-3">
